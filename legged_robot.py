from pinocchio import SE3, Model, Inertia, JointModelRX, JointModelRY, JointModelRZ, \
    ...
    * visuals: the list of all the 'visual' 3D objects to render the robot,
    ...
    def createLeggedRobot(self, rootId=0, prefix=''):
        ...
        for side in ["left", "right"]:
            ...
            self.visuals.append(
                Visual('world/' + prefix + side + 'upperleg', jointId, SE3(eye(3), np.array([0., 0., -0.5]))))
            ...
            self.visuals.append(
                Visual('world/' + prefix + side + 'lowerleg', jointId, SE3(eye(3), np.array([0., 0., -0.5]))))
            ...
            self.visuals.append(
                Visual('world/' + prefix + side + 'foot', jointId, SE3(eye(3), np.array([0., -.1, -0.15]))))
